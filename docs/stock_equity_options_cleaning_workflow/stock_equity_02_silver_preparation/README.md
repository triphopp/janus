...
```bash
mmdc -i docs/stock_equity_options_cleaning_workflow/stock_equity_02_silver_preparation/slides/stock_equity_silver_preparation_slides.mmd -o docs/images/stock_equity_silver_preparation_slides.svg -b white
mmdc -i docs/stock_equity_options_cleaning_workflow/stock_equity_02_silver_preparation/two_col/stock_equity_silver_preparation_2col.mmd -o docs/images/stock_equity_silver_preparation_2col.pdf -b white
```
