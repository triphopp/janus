...
```bash
mmdc -i docs/options_cleaning_workflow/options_cleaning_02_silver_adapter/slides/silver_adapter_workflow_slides.mmd -o docs/images/silver_adapter_workflow_slides.svg -b white
mmdc -i docs/options_cleaning_workflow/options_cleaning_02_silver_adapter/two_col/silver_adapter_workflow_2col.mmd -o docs/images/silver_adapter_workflow_2col.pdf -b white
```
