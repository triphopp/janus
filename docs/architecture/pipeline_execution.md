...
โฟลเดอร์สำหรับเก็บไฟล์รูปภาพที่ export จาก diagram นี้คือ `docs/assets/images/`

ถ้าต้องการใช้ในรายงานหรือ IEEE-style paper แนะนำใช้ diagram ใหญ่นี้เป็น repo documentation หรือ appendix แล้วใช้ชุดรูปย่อยใน `docs/architecture/sections/` สำหรับ body ของงาน ได้แก่ overview, data preparation, validation diagnostics และ metrics/reporting
