...
```bash
mmdc -i docs/workflows/options_cleaning/options_cleaning_03_validation_observability/slides/validation_observability_workflow_slides.mmd -o docs/assets/images/validation_observability_workflow_slides.svg -b white
mmdc -i docs/workflows/options_cleaning/options_cleaning_03_validation_observability/two_col/validation_observability_workflow_2col.mmd -o docs/assets/images/validation_observability_workflow_2col.pdf -b white
```
