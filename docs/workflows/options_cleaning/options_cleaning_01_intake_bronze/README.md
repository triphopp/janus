...
```bash
mmdc -i docs/workflows/options_cleaning/options_cleaning_01_intake_bronze/slides/intake_bronze_workflow_slides.mmd -o docs/assets/images/intake_bronze_workflow_slides.svg -b white
mmdc -i docs/workflows/options_cleaning/options_cleaning_01_intake_bronze/two_col/intake_bronze_workflow_2col.mmd -o docs/assets/images/intake_bronze_workflow_2col.pdf -b white
```
