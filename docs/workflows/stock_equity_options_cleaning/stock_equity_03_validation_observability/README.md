...
```bash
mmdc -i docs/workflows/stock_equity_options_cleaning/stock_equity_03_validation_observability/slides/stock_equity_validation_observability_slides.mmd -o docs/assets/images/stock_equity_validation_observability_slides.svg -b white
mmdc -i docs/workflows/stock_equity_options_cleaning/stock_equity_03_validation_observability/two_col/stock_equity_validation_observability_2col.mmd -o docs/assets/images/stock_equity_validation_observability_2col.pdf -b white
```
