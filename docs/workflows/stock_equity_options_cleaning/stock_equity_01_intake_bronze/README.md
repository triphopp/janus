...
```bash
mmdc -i docs/workflows/stock_equity_options_cleaning/stock_equity_01_intake_bronze/slides/stock_equity_intake_bronze_slides.mmd -o docs/assets/images/stock_equity_intake_bronze_slides.svg -b white
mmdc -i docs/workflows/stock_equity_options_cleaning/stock_equity_01_intake_bronze/two_col/stock_equity_intake_bronze_2col.mmd -o docs/assets/images/stock_equity_intake_bronze_2col.pdf -b white
```
